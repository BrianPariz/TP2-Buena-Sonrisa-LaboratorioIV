...
var CabeceraComponent = /** @class */ (function () {
    function CabeceraComponent(usuarioService, dataApi, http, ns) {
                ...
                _this.dataApi.TraerUno(user.uid, 'usuarios').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1)).subscribe(function (userx) {
                    if (userx) {
                        if (userx.Activo) {
                            ...
                            _this.imagenUrl = userx.ImagenUrl;
                            _this.nombre = userx.Nombre;
                            _this.perfil = userx.Perfil;
    ...
    CabeceraComponent.prototype.emergencia = function () {
        var _this = this;
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            _this.http.get(url).subscribe(function (location) {
                debugger;
                if (location.status == "OK") {
                    var adress = location.plus_code.compound_code;
                    _this.dataApi.AgregarUno("localizacion", adress);
                    _this.ns.success("Ya se envi\u00F3 la ambulancia a su ubicaci\u00F3n " + adress + ", aguarde 20 minutos.");
                }
                else {
                    console.log(location);
                    _this.ns.error("Error", "Sucedió un error al conectarse con el servidor.");
                }
            });
        });
    };
...
var EmpleadosEstadisticaComponent = /** @class */ (function () {
    function EmpleadosEstadisticaComponent(dataApi) {
        this.dataApi = dataApi;
        this.displayedColumns = ['Empleado', 'Dia', 'Horario'];
        this.columnsToDisplay = this.displayedColumns.slice();
    }
    EmpleadosEstadisticaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataApi.TraerTodos('logs')
            .subscribe(function (logs) {
            _this.data = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](logs);
        });
    };
    EmpleadosEstadisticaComponent.prototype.exportExcel = function () {
    ...
    EmpleadosEstadisticaComponent.prototype.exportPdf = function () {
    ...
    return EmpleadosEstadisticaComponent;
}());
...
var EspecialidadEstadisticaComponent = /** @class */ (function () {
    function EspecialidadEstadisticaComponent(ns, dataApi) {
        this.ns = ns;
        this.dataApi = dataApi;
        this.panelOpenState = false;
    }
    EspecialidadEstadisticaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataApi.TraerTodos("turnos").subscribe(function (turnos) {
            if (turnos) {
                _this.turnos = turnos;
                _this.cargarEspecialidades();
    ...
    EspecialidadEstadisticaComponent.prototype.cargarEspecialidades = function () {
        var countDen = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_4__["Especialidad"].Odontologia; }).length;
        var countDer = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_4__["Especialidad"].Dermatologia; }).length;
        var countPsi = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_4__["Especialidad"].Psicologia; }).length;
        var countOnc = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_4__["Especialidad"].Oncologia; }).length;
    ...
    EspecialidadEstadisticaComponent.prototype.cargarComentarios = function () {
        var _this = this;
        this.mejoresComentarios = [];
        this.peoresComentarios = [];
        var turnosEncuestados = this.turnos.filter(function (x) { return x.Estado == src_app_clases_Turno__WEBPACK_IMPORTED_MODULE_5__["EstadoTurno"].Finalizado && x.Encuesta != null; });
        if (turnosEncuestados.length > 0) {
            var puntuacionesEsp = turnosEncuestados.map(function (obj) {
                return Number.parseInt(obj.Encuesta.PuntuacionEspecialista);
            });
            var maxValue = Math.max.apply(Math, puntuacionesEsp);
            var minValue = Math.min.apply(Math, puntuacionesEsp);
            turnosEncuestados.forEach(function (element) {
                var comentario = {
                    NombreCliente: "",
                    Comentario: ""
                };
                if (Number.parseInt(element.Encuesta.PuntuacionEspecialista) == maxValue) {
                    ...
                    _this.mejoresComentarios.push(comentario);
                }
                else if (Number.parseInt(element.Encuesta.PuntuacionEspecialista) == minValue) {
                    comentario.Comentario = element.Encuesta.Opinion;
                    comentario.NombreCliente = element.NombreCliente;
                    _this.peoresComentarios.push(comentario);
                }
            });
        }
    };
    ...
    return EspecialidadEstadisticaComponent;
}());
...
var ListaSalasComponent = /** @class */ (function () {
    function ListaSalasComponent(dataApi) {
        this.dataApi = dataApi;
        this.displayedColumns = ['Codigo', 'Estado', 'Ocupar'];
    }
    ListaSalasComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataApi.TraerTodos('consultorios')
            .subscribe(function (consultorios) {
            _this.consultorios = consultorios;
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.consultorios);
        });
    };
    ListaSalasComponent.prototype.ocupar = function (id) {
        var consult = this.consultorios.filter(function (x) { return x.id == id; })[0];
        if (consult) {
            ...
            this.consultorios.find(function (x) { return x.id == id; }).Estado = src_app_clases_Sala__WEBPACK_IMPORTED_MODULE_4__["EstadoConsultorio"].Ocupado;
        }
    };
    ListaSalasComponent.prototype.applyFilter = function (filterValue) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.testAdmin = function () {
        this.emailModel = "brianpariz@hotmail.com";
        this.passwordModel = "olaquetal";
    };
    LoginComponent.prototype.testRecepcionista = function () {
        this.emailModel = "pedro@gmail.com";
        this.passwordModel = "olaquetal";
    };
    LoginComponent.prototype.testCliente = function () {
        this.emailModel = "rodo@gmail.com";
        this.passwordModel = "olaquetal";
    };
    LoginComponent.prototype.testEspecialista = function () {
...
var ModalEncuestaComponent = /** @class */ (function () {
    function ModalEncuestaComponent(dialogRef, _Encuesta) {
    ...
    ModalEncuestaComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    ModalEncuestaComponent.prototype.aceptar = function () {
...
var ModalObservacionesComponent = /** @class */ (function () {
    function ModalObservacionesComponent(dialogRef) {
        this.dialogRef = dialogRef;
    ...
    ModalObservacionesComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    ModalObservacionesComponent.prototype.aceptar = function () {
    ...
    return ModalObservacionesComponent;
}());
...
var RegistroComponent = /** @class */ (function () {
    function RegistroComponent(usuarioService, storage, elRef) {
        this.usuarioService = usuarioService;
    ...
    RegistroComponent.prototype.changePerfil = function (perfil) {
        this.perfil = perfil;
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var TurnoCreacionComponent = /** @class */ (function () {
    function TurnoCreacionComponent(fb, dataApi, usuarioService, ns) {
        this.fb = fb;
        this.dataApi = dataApi;
        this.usuarioService = usuarioService;
        this.ns = ns;
    ...
    TurnoCreacionComponent.prototype.CrearTurno = function () {
        var _this = this;
        this.dataApi.TraerTodos('consultorios').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["take"])(1)).subscribe(function (consultorios) {
            var consultorio = consultorios[Math.floor((Math.random() * 5))];
            var especialista = _this.especialistaForm.value;
            var cliente = _this.clienteForm.value;
            var creadoCliente = true;
            var UidRecepcionista = null;
            var NombreRecepcionista = null;
            if (_this.perfil != src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_3__["Perfil"].Cliente) {
                creadoCliente = false;
                UidRecepcionista = _this.user.Uid;
                NombreRecepcionista = _this.user.Nombre;
            }
            var turno = {
    ...
    TurnoCreacionComponent.prototype.TraerClientes = function () {
        var _this = this;
        this.dataApi.TraerTodos('usuarios').subscribe(function (usuarios) {
            _this.clientes = usuarios.filter(function (x) { return x.Perfil == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_3__["Perfil"].Cliente && x.Activo; });
        });
    };
            ...
            _this.dataApi.TraerTodos('usuarios').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["take"])(1)).subscribe(function (usuarios) {
                ...
                especialistasAux.forEach(function (element) {
                    if (turnos.filter(function (x) { return x.UidEspecialista == element.Uid; }).length < 3) {
                        _this.especialistas.push(element);
                    }
                });
            });
        });
...
var TurnoListaComponent = /** @class */ (function () {
    function TurnoListaComponent(dataApi, usuarioService, dialog, ns) {
        this.dataApi = dataApi;
        this.usuarioService = usuarioService;
        this.dialog = dialog;
        this.ns = ns;
    ...
    TurnoListaComponent.prototype.ngOnInit = function () {
        ...
        this.dataApi.TraerTodos('turnos')
            ...
            if (_this.perfil == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_7__["Perfil"].Cliente)
                _this.turnos = turnos.filter(function (x) { return x.UidCliente == _this.usuarioService.usuario.Uid; });
            else if (_this.perfil == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_7__["Perfil"].Recepcionista) {
                _this.turnos = turnos;
            }
            else if (_this.perfil == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_7__["Perfil"].Especialista)
                _this.turnos = turnos.filter(function (x) { return x.UidEspecialista == _this.usuarioService.usuario.Uid; });
            ;
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](_this.turnos);
            _this.noData = _this.dataSource.connect().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return data.length === 0; }));
        });
    };
    TurnoListaComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
    };
    TurnoListaComponent.prototype.cancelarTurno = function (turno) {
    ...
    TurnoListaComponent.prototype.realizarEncuesta = function (turno) {
        var _this = this;
        var encuesta = {
        ...
        var dialogRef = this.dialog.open(_modal_encuesta_modal_encuesta_component__WEBPACK_IMPORTED_MODULE_8__["ModalEncuestaComponent"], {
            data: { encuesta: encuesta }
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result != undefined) {
                turno.Encuesta = result;
                _this.dataApi.ModificarUno(turno, 'turnos');
                _this.ns.success("Se envió la encuesta exitosamente");
            }
        });
    };
    TurnoListaComponent.prototype.finalizarTurno = function (turno) {
        var _this = this;
        var dialogRef = this.dialog.open(_modal_observaciones_modal_observaciones_component__WEBPACK_IMPORTED_MODULE_10__["ModalObservacionesComponent"]);
        dialogRef.afterClosed().subscribe(function (result) {
            if (result != undefined) {
                _this.dataApi.TraerUno(turno.ConsultorioId, 'consultorios').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe(function (consultorio) {
                    consultorio.Estado = src_app_clases_Sala__WEBPACK_IMPORTED_MODULE_11__["EstadoConsultorio"].Libre;
                    _this.dataApi.ModificarUno(consultorio, "consultorios");
                });
                ...
                _this.dataApi.ModificarUno(turno, 'turnos');
                _this.ns.success("Se envió la observación exitosamente");
            }
        });
    };
...
var TurnoComponent = /** @class */ (function () {
    function TurnoComponent(usuarioService) {
        this.usuarioService = usuarioService;
        this.perfil = this.usuarioService.usuario.Perfil;
    }
...
var TurnosEstadisticaComponent = /** @class */ (function () {
    function TurnosEstadisticaComponent(ns, dataApi) {
        this.ns = ns;
        this.dataApi = dataApi;
        this.panelOpenState = false;
    ...
    TurnosEstadisticaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataApi.TraerTodos("turnos").subscribe(function (turnos) {
            if (turnos) {
                _this.turnos = turnos;
                _this.cargarTurnosLists();
            }
        });
        this.dataApi.TraerTodos("usuarios").subscribe(function (usuarios) {
            if (usuarios) {
                _this.usuarios = usuarios;
                _this.cargarClientesLists();
                _this.cargarRecepcionistasLists();
            }
        });
    };
    TurnosEstadisticaComponent.prototype.buscarTurnos = function () {
        ...
        var turnosList;
        turnosList = this.turnos.filter(function (x) { return x.Fecha.toDate() >= fechaDesde && x.Fecha.toDate() <= fechaHasta; });
        this.resultTurnosCount = "Cantidad de turnos entre las fechas dadas: " + turnosList.length;
    };
    TurnosEstadisticaComponent.prototype.cargarTurnosLists = function () {
        this.countDen = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Odontologia; }).length;
        this.countDer = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Dermatologia; }).length;
        this.countPsi = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Psicologia; }).length;
        this.countOnc = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Oncologia; }).length;
        this.countDenCancel = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Odontologia && x.Estado == src_app_clases_Turno__WEBPACK_IMPORTED_MODULE_5__["EstadoTurno"].Cancelado; }).length;
        this.countDerCancel = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Dermatologia && x.Estado == src_app_clases_Turno__WEBPACK_IMPORTED_MODULE_5__["EstadoTurno"].Cancelado; }).length;
        this.countPsiCancel = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Psicologia && x.Estado == src_app_clases_Turno__WEBPACK_IMPORTED_MODULE_5__["EstadoTurno"].Cancelado; }).length;
        this.countOncCancel = this.turnos.filter(function (x) { return x.Especialidad == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Especialidad"].Oncologia && x.Estado == src_app_clases_Turno__WEBPACK_IMPORTED_MODULE_5__["EstadoTurno"].Cancelado; }).length;
    };
    TurnosEstadisticaComponent.prototype.cargarClientesLists = function () {
        var _this = this;
        this.turnosClientes = [];
        this.usuarios.forEach(function (element) {
            if (element.Perfil == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Perfil"].Cliente) {
                var turnosCount = _this.turnos.filter(function (x) { return x.CreadoPorCliente && x.NombreCliente == element.Nombre; }).length;
                var turno = {
                    Nombre: element.Nombre,
                    CountTurnos: turnosCount
                };
                _this.turnosClientes.push(turno);
            }
        });
    };
    TurnosEstadisticaComponent.prototype.cargarRecepcionistasLists = function () {
        var _this = this;
        this.turnosRecepcionistas = [];
        this.usuarios.forEach(function (element) {
            if (element.Perfil == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_6__["Perfil"].Recepcionista) {
                var turnosCount = _this.turnos.filter(function (x) { return !x.CreadoPorCliente && x.NombreRecepcionista == element.Nombre; }).length;
                var turno = {
                    Nombre: element.Nombre,
                    CountTurnos: turnosCount
                };
                _this.turnosRecepcionistas.push(turno);
            }
        });
    };
    ...
    return TurnosEstadisticaComponent;
}());
...
var BotonSeleccionadoDirective = /** @class */ (function () {
    function BotonSeleccionadoDirective() {
        this.defaultColor = 'white';
        this.highlightColor = '#6e9de4';
    }
    BotonSeleccionadoDirective.prototype.mouseover = function (eventData) {
        this.backgroundColor = this.highlightColor;
    };
    BotonSeleccionadoDirective.prototype.onMouseLeave = function () {
    ...
    return BotonSeleccionadoDirective;
}());
                    ...
                    _this.dataApi.TraerUno(userData.user.uid, 'usuarios').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(function (userx) {
                        if (!userx.Activo) {
                            ...
                            if (userx.Perfil == _clases_Usuario__WEBPACK_IMPORTED_MODULE_5__["Perfil"].Especialista || userx.Perfil == _clases_Usuario__WEBPACK_IMPORTED_MODULE_5__["Perfil"].Recepcionista) {
                                ...
                                _this.dataApi.AgregarUno(estEmpl, 'logs');
                            }
