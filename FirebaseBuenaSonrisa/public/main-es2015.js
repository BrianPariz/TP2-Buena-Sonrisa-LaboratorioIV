...
let TurnoCreacionComponent = class TurnoCreacionComponent {
    constructor(fb, dataApi, usuarioService) {
        this.fb = fb;
        this.dataApi = dataApi;
        this.usuarioService = usuarioService;
    ...
    ngOnInit() {
        ...
        this.dataApi.TraerTodos('usuarios').subscribe(usuarios => {
            this.especialistas = usuarios.filter(x => x.Perfil == src_app_clases_Usuario__WEBPACK_IMPORTED_MODULE_3__["Perfil"].Especialista && x.Activo);
        });
    }
    get fecha() {
